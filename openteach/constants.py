...
KINOVA_VELOCITY_SCALING_FACTOR = 10
...
NUM_CAMS = 4
# CAM_FPS = 30
CAM_FPS = 15 # fix the issue that the video is twice shorter than the metadata
CAM_FPS_SIM = 60
WIDTH = 1280
HEIGHT = 720
...
# Audio Connections
COLLECT_PORT = 8126       # start/stop messages: "1" / "0"
SESSION_PORT = 8123       # session name text
AUDIO_PORT = 50010        # headset audio port
